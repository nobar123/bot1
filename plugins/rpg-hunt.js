...
let handler = async (m, { conn, text }) => {
  ...
  if (new Date - db.data.users[m.sender].lasthunt > 120000) {
    ...
    dmg = dmg < 0 ? Math.abs(dmg) : parseInt(Math.floor(Math.random() * 50))
